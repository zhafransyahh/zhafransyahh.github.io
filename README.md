...
**Theme:** Dark editorial. Navy-black background, cool off-white type, Baltic Blue accent. Serious, premium, intentionally non-generic.
...
| Page | Accent | Hex |
|---|---|---|
| `cs-lender-integration.html` | Baltic Blue | `#586994` |
